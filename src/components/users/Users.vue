        ...
        <v-dialog max-width="1000">
          <template v-slot:activator="{props: activatorProps}">
            <v-btn v-bind="activatorProps" color="green" class="pr-1 pl-1" min-width="0">
              ...
              <span v-if="!isMobile">Создать пользователя</span>
            </v-btn>
          </template>
    ...
    <v-main>
      ...
      >
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="green darken-1" @click="dialogChanges = false; changeRoles(); snackbarChangeUser = true">
              Изменить
            </v-btn>
      ...
      >
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="green darken-1" @click="dialogUnblock = false; changeRoles(); snackbarUnBlock = true">
              Разблокировать
            </v-btn>
                ...
                <v-card class="pa-2">
                  <v-list-item>
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle>Почта: {{ item.email }}</v-list-item-subtitle>
